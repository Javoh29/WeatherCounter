...
import '../../../presentation/components/circular_clipper.dart';
...
class _ThemeScopeState extends State<ThemeScope> with SingleTickerProviderStateMixin {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return Stack(
          children: [
            _body(1),
            ClipPath(clipper: CircularClipper(_animationController.value * radius, position), child: _body(2)),
          ],
        );
      },
    );
